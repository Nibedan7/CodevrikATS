...
namespace CdplATS.API.Services
{
    public class LeaveReportService
    {
        ...
        public async Task<ApiResponse<IEnumerable<LeaveReportEntity>>> GetLeaveReportList(int EmpCode, string? StartDate, string? EndDate)
        {
            try
            {
                ...
                var LeaveReport = await _genericRepository.GetAllAsync<LeaveReportEntity>("GetLeaveReportList", parameters);
