...
! function (t, e) {
	...
	var Fa = function () {
		...
		return e.init = function () {
			if (this.el!=null) t.instances.set(this.el, this), Ie && (this.initDOM(), this.setAccessibilityAttributes(), this.scrollbarWidth = this.getScrollbarWidth(), this.recalculate(), this.initListeners())
		}, e.initDOM = function () {
			var t = this;
