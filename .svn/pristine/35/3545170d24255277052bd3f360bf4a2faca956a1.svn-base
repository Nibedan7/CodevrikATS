...
namespace CdplATS.API.Services
{
    public class CommonServices
    {
        ...
        public async Task<ApiResponse<IEnumerable<EmpDropDownList>>> BindEmployeeHierarchy(int empCode)
        {
            try
            {
                ...
                var emps = await _genericRepository.GetAllAsync<EmpDropDownList>("BindEmployeeHierarchy", parameters);
                return new ApiResponse<IEnumerable<EmpDropDownList>>(emps, "Employee Hierarchy retrieved successfully.");
            }
            catch (Exception ex)
            {
        ...
        public async Task<ApiResponse<IEnumerable<DepartmentList>>> BindDepartmentList()
        {
            try
            {
               
                var departments = await _genericRepository.GetAllAsync<DepartmentList>("BindDepartmentList");
        ...
        public async Task<ApiResponse<IEnumerable<int>>> BindYearList()
        {
            try {


                var festivalYear = await _genericRepository.GetAllAsync<int>("BindYearList");
        ...
        public async Task<ApiResponse<EmailEntity>> SendLeaveSummaryEmail()
        {
            var result = await _genericRepository.GetAsync<EmailEntity>("SendLeaveSummaryEmail", null);

            return new ApiResponse<EmailEntity>(result, "Email retrieved successfully.");

        }


        public async Task<ApiResponse<IEnumerable<ChildWithParentList>>> GetEmployeeDeptsHead(int empCode)
        {
            try
            {
                var parameters = new SqlParameter[]
        ...
        public async Task<ApiResponse<string>> ResetPassword(ResetPasswordEntity model)
        {
            try
            {
                ...
                return new ApiResponse<string>("Password updated successfully.");
            }
            catch (Exception ex)
            {
        ...
        public async Task<ApiResponse<IEnumerable<EmployeeRole>>> BindRoleList()
        {
            var role = await _genericRepository.GetAllAsync<EmployeeRole>("BindRoleList");
            return new ApiResponse<IEnumerable<EmployeeRole>>(role, "Role retrive successfully");

        }

        public async Task<ApiResponse<IEnumerable<Reviewer>>> BindEmployeeList()
        {
            try
            {
                var employees = await _genericRepository.GetAllAsync<Reviewer>("BindEmployeeList");
        ...
        public async Task<ApiResponse<IEnumerable<Reviewer>>> BindReviewerList()
        {
            try
            {
                var employees = await _genericRepository.GetAllAsync<Reviewer>("BindReviewerList");
                return new ApiResponse<IEnumerable<Reviewer>>(employees, "Employee retrieved successfully.");
            }
            catch (Exception ex)
            {
