...
namespace CodeVrikATS.API.Services
{
    public class EmployeeService
    {
        ...
        public EmployeeService(GenericRepository genericRepository, SendEmailCommonAPIService sendEmailCommonAPIService)
        {
        ...
        public async Task<ApiResponse<string>> AddEditEmployee(EmployeeEntity request)
            ...
            try
            {
                var parameters = new SqlParameter[]
                {
                    ...
                    new SqlParameter("@AccessCardNumber", SqlDbType.VarChar) { Value = request.AccessCardNumber },
                    ...
                    new SqlParameter("@AnnualLeave", SqlDbType.Int) {Value = request.AnnualLeave }
                };
                ...
                {
                    return new ApiResponse<string> { Success = true, Message = "Employee added successfully." };
                }
                else if (result.IsSuccess == 1 && request.Id != 0)
                {
        ...
        public async Task<ApiResponse<bool>> DeleteEmployee(int Id,int status)
        {
            try
            {
               ...
               var result = await _genericRepository.ExecuteAsync("DeleteEmployee", parameters);
                ...
                {
                    return new ApiResponse<bool>(true, "Employee Removed successfully.", true);
                }
                ...
                {
                    return new ApiResponse<bool>(true, "Failed to Removed/Revoke Employee.", true);
                }
        ...
        public async Task<ApiResponse<string>> StartEmployeeAssessment(EmployeeAssessmentEntity request)
        {
            try
            {
                var parameters = new SqlParameter[]
                {
                    new SqlParameter("@EmployeeCode", SqlDbType.Int) { Value = request.EmployeeCode },
                    new SqlParameter("@AssessmentName", SqlDbType.NVarChar) { Value = request.AssessmentName },
                    new SqlParameter("@Reviewer1", SqlDbType.NVarChar) { Value = request.Reviewer1Id },
                    new SqlParameter("@Reviewer2", SqlDbType.Int) { Value = request.Reviewer2Id },
                    new SqlParameter("@AssessmentStartDate", SqlDbType.Date) { Value = request.AssessmentStartDate },
                    new SqlParameter("@AssessmentEndDate", SqlDbType.Date) { Value = request.AssessmentEndDate},
                };

                var result = await _genericRepository.GetAsync<dynamic>("StartEmployeeAssessment", parameters);

                if (result.IsSuccess == -1)
                {
                    return new ApiResponse<string> { Success = false, Message = "Assessment Name already exists!" };
                }
                else if (result.IsSuccess == 1)
                {
                    return new ApiResponse<string> { Success = true, Message = "Employee assessment started successfully." };
                }
                else
                {
                    return new ApiResponse<string> { Success = false, Message = "Failed to start employee assessment data." };
                }
            }
            catch (Exception ex)
            {
                return new ApiResponse<string> { Success = false, Message = $"Error starting employee assessment data: {ex.Message}" };
            }
        }

        public async Task<ApiResponse<string>> SaveEmployeeAssessment(EmployeeAssessmentEntity request)
        {
            try
            {
                var parameters = new SqlParameter[]
                {
                    new SqlParameter("@EmployeeAssessmentId", SqlDbType.Int) { Value = request.EmployeeAssessmentId },
                    new SqlParameter("@EmployeeCode", SqlDbType.Int) { Value = request.EmployeeCode },
                    new SqlParameter("@AssessmentName", SqlDbType.NVarChar) { Value = request.AssessmentName },
                    new SqlParameter("@Reviewer1", SqlDbType.NVarChar) { Value = request.Reviewer1Id },
                    new SqlParameter("@Reviewer2", SqlDbType.Int) { Value = request.Reviewer2Id },
                ...
                var result = await _genericRepository.GetAsync<dynamic>("SaveEmployeeAssessment", parameters);
                ...
                {
                    return new ApiResponse<string> { Success = true, Message = "Employee assessment saved successfully." };
                }
                else
                {
                    return new ApiResponse<string> { Success = false, Message = "Failed to save employee assessment data." };
                }
            }
            catch (Exception ex)
            {
                return new ApiResponse<string> { Success = false, Message = $"Error saving employee assessment data: {ex.Message}" };
            }
        }

        public async Task<ApiResponse<string>>AppraisalMail(EmployeeAssessmentEntity request)
        {
            var parameters = new SqlParameter[]
            {
                new SqlParameter("@EmployeeCode", SqlDbType.Int) { Value = request.EmployeeCode },
                new SqlParameter("@Reviewer1Code", SqlDbType.NVarChar) { Value = request.Reviewer1Id },
                new SqlParameter("@Reviewer2Code", SqlDbType.Int) { Value = request.Reviewer2Id }
            };
            var result = await _genericRepository.GetAsync<EmailEntity>("SendMailForAppraisal", parameters);

            await _sendEmailCommonAPIService.SendEmail(result);
            return new ApiResponse<string>("Mail Sent sccessfully.");
        }

        public async Task<ApiResponse<string>> AppraisalMailToReviewer2(EmployeeAssessmentEntity request)
        {
            var parameters = new SqlParameter[]
            {
                new SqlParameter("@EmployeeCode", SqlDbType.Int) { Value = request.EmployeeCode },
            ...
            var result = await _genericRepository.GetAsync<EmailEntity>("SendMailToReviewer2", parameters);
