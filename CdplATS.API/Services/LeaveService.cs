...
namespace CdplATS.API.Services
{
    public class LeaveService
    {
        ...
        public LeaveService(GenericRepository genericRepository, SendEmailCommonAPIService sendEmailCommonAPIService)
        {
            _genericRepository = genericRepository;
            this._sendEmailCommonAPIService = sendEmailCommonAPIService;
        }

        public async Task<ApiResponse<IEnumerable<LeaveEntity>>> GetLeaveByEmpCode(int? EmpCode, int? Status, string? GroupId, int? Year, int? LoggedEmpCode)
        {
            try
            {
        ...
        public async Task<ApiResponse<string>> AddEditLeave(LeaveEntity leaveEntity)
        {
            try
            {
                var parameters = new SqlParameter[]
        ...
        public async Task<ApiResponse<string>> DeleteLeave(string groupId)
        {
            try
            {
                var parameters = new SqlParameter[]
        ...
        public async Task<ApiResponse<string>> ApproveRejectLeave(string groupId, int status, int empCode)
        {
            try
            {
                var parameters = new SqlParameter[]
        ...
        public async Task<ApiResponse<IEnumerable<EmpDropDownList>>> GetLeaveCountByEmpCode(int empCode, int year)
        {
            try
            {
                var parameters = new SqlParameter[]
        ...
        public async Task<ApiResponse<string>> SendLeaveAppliedEmail(LeaveEntity leaveEntity)
        {
            try
            {
                var parameters = new SqlParameter[]
                {
                    new SqlParameter("@EmployeeCode", SqlDbType.Text) { Value = leaveEntity.EmpCode },
                    new SqlParameter("@GroupId", SqlDbType.Text) { Value = leaveEntity.GroupId },
                    new SqlParameter("@StartDate", SqlDbType.Text) { Value = leaveEntity.StartDate },
                    new SqlParameter("@EndDate", SqlDbType.Text) { Value = leaveEntity.EndDate },
                    new SqlParameter("@LeaveType", SqlDbType.Text) { Value = leaveEntity.LeaveType },
                    new SqlParameter("@Reason", SqlDbType.Text) { Value = leaveEntity.Reason },
                };
                var result = await _genericRepository.GetAsync<EmailEntity>("SendLeaveAppliedEmail", parameters);
        ...
        public async Task<ApiResponse<string>> SendLeaveApproveRejectEmail(string GroupId)
        {
            try
            {
                var parameters = new SqlParameter[]
                ...
                var result = await _genericRepository.GetAsync<EmailEntity>("SendLeaveApproveRejectEmail", parameters);
                await _sendEmailCommonAPIService.SendEmail(result);
                return new ApiResponse<string>("Mail Sent sccessfully.");
            }
            catch (Exception ex)
